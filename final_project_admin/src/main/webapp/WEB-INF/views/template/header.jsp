      ...
      <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav">
            ...
            <li class="nav-item"><a href="${pageContext.request.contextPath}/calculate/total?year=${year}&month=${month}" class="nav-link">정산</a></li>
            ...
            <li class="nav-item"><a href="${pageContext.request.contextPath}/sales/status" class="nav-link">사이트매출현황</a></li>
