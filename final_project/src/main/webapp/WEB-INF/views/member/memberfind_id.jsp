	...
	<form action="memberfind_id" method="post">
		<fieldset>
	    	<div class="form-group">
				...
				<input type="text" name="member_name" id="exampleInputId" class="form-control" placeholder="이름" required>
	 			<div class="row-empty-20"></div>
	 			<label for="exampleInputPassword1">PW:</label>
	 			<input type="text" name="member_email" class="form-control" id="exampleInputPassword1" placeholder="Password" required>
				<div class="row-empty-20"></div>
