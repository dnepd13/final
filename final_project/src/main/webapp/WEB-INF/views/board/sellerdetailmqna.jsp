...
<tbody>
	<tr>
		...
		<td width="600px" style="word-break:break-all;">${sellerQnaGetOne.admin_qna_title}</td>
	</tr>
		<tr>
	...
	<tr>
		...
		<td width="600px" >
			<textarea readonly="readonly" rows="15" cols="100" style="resize:none;" class="form-control">	${sellerQnaGetOne.admin_qna_content}</textarea>
		</td>
		...
		<p align="right">
			<c:choose>
				<c:when test="${sellerQnaGetOne.admin_no >0}">	
					<h4>관리자의 답변입니다.</h4>
				</c:when>
			<c:otherwise>
