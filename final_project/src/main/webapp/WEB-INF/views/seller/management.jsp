...
<!--   <button type="button" class="btn btn-priamry" onclick="location='../goods/goodsList'">상품목록</button><br> -->
<!--   <button type="button" class="btn btn-primary" onclick="location='../goods/goodsUpdate'">상품수정</button><br> -->
  <h3>판매관리</h3><br>
