...
// 멤버 주문제작 요청서 작성 페이지
	...
	public String memberCustom(HttpSession session, 
												...
												@ModelAttribute MemberCustomOrderDto memberCustomDto,
												@ModelAttribute SellerCustomAlarmDto sellerCustomAlarmDto) {
		...
		memberCustomService.MemberCustom(session, seller_no, customOrderDto, memberCustomDto, sellerCustomAlarmDto);
	...
	public String memberCustomList(Model model, HttpSession session) {
		...
		// 모든 견적서
		model.addAttribute("getListCustom", memberCustomDao.getListCustom());
